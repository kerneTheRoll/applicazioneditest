...
var EmployeeComponent = /** @class */ (function () {
    function EmployeeComponent(employeService) {
    ...
    EmployeeComponent.prototype.onSubmit = function (f) {
        var _this = this;
        this.employeService.postEmploye(f.value).subscribe(function (data) {
            console.log(f.value);
            _this.getAllEmployes();
            f.form.reset();
        });
    };
    ...
    EmployeeComponent.prototype.getAllEmployes = function () {
        var _this = this;
        this.employeService.getEmployes().subscribe(function (data) {
            _this.employeService.employes = data;
            _this.employeService.employes.sort(_this._comparaElemetn);
        });
    };
    EmployeeComponent.prototype._comparaElemetn = function (a, b) {
        if (a.code < b.code)
            return -1;
        if (a.code > b.code)
            return 1;
    ...
    EmployeeComponent.prototype._helperElement = function (item, form) {
    ...
    EmployeeComponent.prototype.changeElement = function (form) {
        var _this = this;
        this.employeService.putEmploye(form.value).subscribe(function (data) {
            console.log(data);
            _this.getAllEmployes();
        });
    };
    EmployeeComponent.prototype.seleziona = function (item) {
        // this.form.controls["name"].setValue(item.name);
        this.activeChange = false;
        this._helperElement(item, this.form);
    };
    EmployeeComponent.prototype.getTargetItem = function (item) {
        var _this = this;
        console.log(item.code);
        // this.form.controls["name"].setValue(item.code);
        if (confirm("sicuro di voler eliminare " + item.name + " ?")) {
            this.employeService.deleteEmploye(item.code).subscribe(function (data) {
                console.log(data);
                _this.getAllEmployes();
            });
        }
    };
    EmployeeComponent.prototype.refreshForm = function (f) {
        this.activeChange = true;
        f.form.reset();
    };
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.getElement = function (items) {
        this.item = items;
    };
...
var EmployeModel = /** @class */ (function () {
    function EmployeModel(code, name, gender, salarioAnnuale, annoDiNascita) {
        if (code === void 0) { code = ""; }
        if (name === void 0) { name = ""; }
        if (gender === void 0) { gender = ""; }
        if (salarioAnnuale === void 0) { salarioAnnuale = 0; }
        if (annoDiNascita === void 0) { annoDiNascita = ""; }
        this.code = code;
        this.name = name;
        this.salarioAnnuale = salarioAnnuale;
        this.annoDiNascita = annoDiNascita;
    }
    EmployeModel.ctorParameters = function () { return [
        null,
        null,
        null,
        null,
...
var EmployeService = /** @class */ (function () {
    ...
    EmployeService.prototype.postEmploye = function (employe) {
        return this.http.post(this.URL_API, employe);
    };
    EmployeService.prototype.getEmploye = function (code) {
        return this.http.get(this.URL_API + ("/" + code));
    };
    EmployeService.prototype.putEmploye = function (employe) {
        return this.http.put(this.URL_API + ("/" + employe.code), employe);
    };
    EmployeService.prototype.deleteEmploye = function (code) {
